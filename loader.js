...
<a href="/info/cookies.html" target="_blank" style="color: var(--link-hover3); font-weight: 300; text-decoration: none; cursor: pointer;"
   onmouseenter="this.style.color='var(--link-hover)'" 
   onmouseleave="this.style.color='var(--link-hover3)'" >
   Ver política de cookies
    ...
    btnYes.style.cssText = baseBtnStyle + `
      ...
      color: var(--text-color);
    `;
    btnYes.onmouseenter = () => { btnYes.style.backgroundColor = "var(--link-hover2)"; btnYes.style.color = "var(--text-color)"; };
    btnYes.onmouseleave = () => { btnYes.style.backgroundColor = "var(--link-hover)"; btnYes.style.color = "var(--text-color)"; };
    btnYes.onclick = () => {
